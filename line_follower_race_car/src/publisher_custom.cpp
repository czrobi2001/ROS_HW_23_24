#include "bme_ros_tutorials/Test_bme.h" // Our custom message type used in the node
#include "ros/ros.h"
...
int main(int argc, char **argv) {
  ...
  ros::Publisher pub =
      nh.advertise<bme_ros_tutorials::Test_bme>("publisher_custom_topic", 10);
  ...
  bme_ros_tutorials::Test_bme test_message;
  ...
  test_message.first_name = "Robert"; // Initializing first name string
  test_message.last_name = "Czeman";  // Initializing last name string
